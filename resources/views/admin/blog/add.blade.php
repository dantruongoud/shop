    ...
    <div class="row" style="padding: 20px 50px; background-color: #FFF">
        <form method="post" enctype="multipart/form-data" style="width: 100%">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" name="title" type="text" placeholder="Title blogs...">
                </div>
            </div>

            <div class="field">
                <label style="padding: 3px 0px" class="label">Images</label>
                <input style="box-shadow: none; border: none; width: 50%" class="input" type="file" name="image">
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea id="content" name="content" class="textarea" placeholder="Content blogs..."></textarea>
                </div>
            </div>
            ...
            <div class="field is-grouped">
                ...
                <div class="control">
                    <a href="{{ url('/admin/blog/list') }}" class="button is-link is-light">Cancel</a>
                </div>
